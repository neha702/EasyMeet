                        ...
                        <div className="container">
                            ...
                            <div className="row">
                                <div className="offset-xl-3 col-xl-6 offset-lg-2 col-lg-8 col-md-12 col-sm-12">
                                    <h1 style={{ color: "black" }}><strong>EasyMeet</strong></h1>
                                    <p style={{ color: "black" }}>An ideal discussion forum for students and teachers to facilitate with video calling and chat features in this current pandemic period.</p>
                                </div>
                            </div>
                        </div>
                    </div>
